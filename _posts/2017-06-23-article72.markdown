...
layout:     post
title:      "Docker 快速入门"
subtitle:   "第一个Docker化的Java应用"
date:       2017-06-23 12:00:00
author:     "Xiaosheng"
header-img: "img/bg/bg_article_72.jpg"
catalog:  true
tags:
    - Docker
---
...
![1](/img/article/article_72_1.png)
...
![2](/img/article/article_72_2.png)
...
![3](/img/article/article_72_3.png)
...
![4](/img/article/article_72_4.jpg)
...
![5](/img/article/article_72_5.png)
...
![6](/img/article/article_72_6.jpg)

下面我们通过 `http://127.0.0.1:8888/press-web-newest` 尝试访问 Jpress，会自动跳转到 Jpress 的安装界面：

![7](/img/article/article_72_7.jpg)

![8](/img/article/article_72_8.jpg)
