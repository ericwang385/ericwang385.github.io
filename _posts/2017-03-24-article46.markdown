...
在上一篇[《HMM 隐马尔可夫模型（上）》](/2017/03/23/article45/)中，我们通过一个掷骰子的例子，简单地阐述了一下 HMM 的基本概念，以及 HMM 关注问题的解决方法。文本将正式介绍隐马尔可夫模型的数学定义，并通过一个实例，演示具体问题的求解过程。
...
![1](/img/article/article_46_1.png)
